            ...
            <Modal
              ...
              footer={[
                <Flex key={1} className="justify-center pt-5">
                  {success ? (
                    <div>
                      <Link to={`${import.meta.env.VITE_URL_FRONT}/answer/${id}`}>{import.meta.env.VITE_BASE_URL}/answer/{id}</Link>
                      <Button onClick={() => setModalOpen(false)} key="ok" type="primary">
                        Ok
                      </Button>
                    </div>
                  ) : (
                    <Button onClick={() => setModalOpen(false)} key="cancel" danger>
                      Cancel
                    </Button>
                  )}
                </Flex>,
